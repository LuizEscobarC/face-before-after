...
module: "marcos/M3_OVERLAYS"
file_path: ".claude/plans/marcos/M3_OVERLAYS.md"
doc_type: "decision"
created_at: "2026-05-24"
updated_at: "2026-05-24"
version: "1.0.0"
summary_context: >
  > Plano detalhado do Marco 3 — overlays visuais SVG cliente + raster server + heatmaps + composição before/ideal. > Releia junto com ../PLANMETRICS.md e ./M2BACKLOG.md. > Atualização: 2026-05-08 split do PLANMETRICS §7, ainda não iniciado.
tags:
  - "planning"
rag_keywords:
  - "SVG overlay"
