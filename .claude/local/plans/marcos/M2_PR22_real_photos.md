...
module: "marcos/M2_PR22_real_photos"
file_path: ".claude/plans/marcos/M2_PR22_real_photos.md"
doc_type: "decision"
created_at: "2026-05-24"
updated_at: "2026-05-24"
version: "1.0.0"
summary_context: >
  > Roadmap operacional para PR-22: Calibração com fotos reais. > Esta é uma tarefa humana operador — IA pode preparar tooling, mas a coleta + julgamento são seus. > Pré-requisito para promover regionmetricweights v1.5 → v2.0 e metricideal v1.0 → v2.0. > Última atualização: 2026-05
tags:
  - "planning"
rag_keywords:
  - "marcos"
