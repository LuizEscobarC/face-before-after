...
**M2 (em andamento)**: PR-12 entregou scoring infra; PR-13 (`jaw`, 6 métricas), PR-14 (`nose`, 7 métricas), PR-15 (`mouth/lips`, 7 métricas), PR-16 (`brows`, 8 métricas), PR-17 (`cheekbones`, 5 métricas) e PR-18 (`forehead`, 4 métricas — 3 activas + 1 pixel-dep stub) já entregues. Total: 116 testes Vitest, 868 testes Python. DB com 58 metric_definitions, 56 metric_ideals, region_metric_weight (jaw=6, eyes=6, symmetry=14, nose=7, mouth=7, brows=6, cheekbones=5, forehead=3). Próximas fatias do M2: PR-19 (global_shape), PR-20 (phi/golden presentation_only), PR-21 (recalibração v2.0), PR-22 (calibração com fotos reais), PR-23 (multi-foto + perfil sagital + philtrum). Detalhe em [`PLAN_M2_BACKLOG.md`](./PLAN_M2_BACKLOG.md).
