...
> Última atualização: 2026-05-09 (após PR-33 — M3.1 overlay render pipeline completo).
...
**M3.1 completo (PR-30..33)**: Overlay Catalog DDL+seed v1.0 (PR-30), Python `/vision/render` Pillow renderer (PR-32), Frontend `<OverlayLayer>` SVG (PR-31), Nest `RenderedAssetService` + `POST /v1/overlays/:id/render` + MinioStorageService (PR-33). Commits: `7afb545`, `bb600bf`, `70d5402`, `46305d9`. Próximos: M3.2 improvement vectors PR-34..36 (Sonnet), M3.3 heatmaps PR-37/38 (Opus required).
