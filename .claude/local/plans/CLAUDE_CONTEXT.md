...
module: "plans/CLAUDE_CONTEXT"
file_path: ".claude/plans/CLAUDE_CONTEXT.md"
doc_type: "decision"
created_at: "2026-05-24"
updated_at: "2026-05-24"
version: "1.0.0"
summary_context: >
  Projeto: face-before-after Stack: generic Uso: Cole como contexto inicial em qualquer nova sessão. Modelo de referência: Claude Sonnet 4.6 padrão | Haiku 4.5 triagem | Opus 4.6 decisões críticas Gerado por: context-framework-installer Última revisão: 2026-05
tags:
  - "planning"
rag_keywords:
  - "context"
...
Ao fim de cada fase, salvar em `.claude/window-context/current.md`:
...
3. /prompt-initializer
   └→ Cria .claude/prompts/[domain]/task-[slug]-[date].prompt.md
