...
- `.claude/local/plans/produto-compartilhavel.md` (referencia de escopo fora)
...
- referencia de escopo compartilhavel mantida em `.claude/local/plans/produto-compartilhavel.md`
