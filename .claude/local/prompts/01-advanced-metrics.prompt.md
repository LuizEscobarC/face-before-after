...
module: "prompts/01-advanced-metrics.prompt"
file_path: ".claude/prompts/01-advanced-metrics.prompt.md"
doc_type: "decision"
created_at: "2026-05-24"
updated_at: "2026-05-24"
version: "1.0.0"
summary_context: >
  Pipeline atual: detecta 68 landmarks dlib, alinha rosto, gera heatmap de assimetria, calcula métricas em px e normalizadas em %IPD, salva JSON por foto e gera relatório texto comparativo. Falta um conjunto de métricas científicas frontais e um relatório HTML autocontido.
tags:
  - "task-prompt"
  - "metrics"
rag_keywords:
