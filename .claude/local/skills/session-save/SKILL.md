---
name: session-save
description: "Salva o contexto comprimido da sessão atual em .claude/local/window-context/current.md para injeção automática na próxima sessão via UserPromptSubmit hook. Invocar ao final de qualquer tarefa complexa ou quando o Stop hook lembrar."
---
...
2. Escrever o arquivo `.claude/local/window-context/current.md` com o template abaixo.
