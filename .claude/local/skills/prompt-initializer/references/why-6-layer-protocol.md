...
module: "references/why-6-layer-protocol"
file_path: ".claude/skills/prompt-initializer/references/why-6-layer-protocol.md"
...
Modern IDEs hover over identifiers to show their type, signature, and documentation before you ever write a call. This layer replicates that: before suggesting any code, the skill forces resolution of every unknown identifier against `.claude/context/`.
