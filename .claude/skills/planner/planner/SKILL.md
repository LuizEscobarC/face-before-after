...
1. `.claude/context/ai_context_master.md` — table schemas, model relationships
2. `.claude/context/modules/[module]/00-index.md` — business rules index
...
**Output plan:**
1. `clear-cache`
2. Read `.claude/context/modules/water/00-index.md`
