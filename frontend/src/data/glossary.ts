...
/**
 * Glossário de termos técnicos das métricas faciais. Bundled estaticamente
 * para que `MetricExplainer` e a seção "Glossário (referência)" funcionem
 * sem chamada ao backend.
 *
 * Portado de backend/app/domain/layers/glossary.py — fonte de verdade
 * autoritativa sobre como cada métrica é medida.
 *
 * As chaves devem casar com `glossaryKeyFor()` em MetricExplainer.tsx.
 */
